...
pub struct DirectoryUsersQuery {
    ...
    /// Identifiants d'utilisateurs séparés par des virgules (ex. `1,2,3`).
    ids: Option<String>,
    /// Ne garde que les membres d'au moins un de ces groupes (identifiants séparés par des virgules).
    group_ids: Option<String>,
    /// Nombre maximal d'utilisateurs renvoyés, de 1 à 1000 (1000 par défaut).
    limit: Option<u64>,
}
